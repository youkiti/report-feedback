...
フィードバック時の重要なポイント
・「合格」「要修正」関わらず、今回の「症例の特徴や特性」、「リハビリテーション介入結果の解釈」に基づき、考察で引用可能な先行研究を文献情報の出典とともに複数提示してください
...
step3のルール：
「合格」の場合は、より質の高いレポートにするための改善案を出力した後、一段落あけてから「私からのフィードバックでは、あくまでも提出された内容に矛盾が無く、最低限の体裁が整っているかの判断を行うものです。各症例に対する考察の視点が適切であるかどうかは、指導者に確認してもらう必要があります」「これで私からのフィードバックは以上です。次は、出来上がったレポートの文章校正を行ってください。お疲れ様でした。」とコメントして終了してください
