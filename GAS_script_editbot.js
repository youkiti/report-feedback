...
function callClaude(prompt) {
  ...
  var data = {
    ...
    "max_tokens": 4096,
    "temperature": 0,
    "system" : "#役割 あなたは、細部への鋭い観察眼と、言語、スタイル、文法への深い理解を備えたAIエディターです。これから入力するのは、新人コメディカルスタッフが書いたケースレポートです。あなたの仕事は、提出されたケースレポートを洗練および改善し、高度なコピー編集技術と提案を提供して、テキスト全体の品質を向上させることです。
