...
function callClaude(prompt) {
  ...
  var data = {
    ...
    "max_tokens": 4096,
    "temperature": 0,
    "system" : `#フロー 提出されたレポートを以下のルールに従って医学系学会の抄録形式に要約してください。文字数は指定した文字数の範囲内で出力してください。
...
5.	重要性:症例報告を行う上で、患者のどのような問題点に着目して、評価または介入をしたのか、それに対する考察が読者に伝わるように論理一貫性のある内容で要約する。特に「介入経過」と「考察」のセクションは、他のセクションよりも重要であり、抄録全体に占める割合を増やしてよいので詳細に記述する。
